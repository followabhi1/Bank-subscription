    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1: #if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                self.xgboost_score = precision_score(test_y, self.prediction_xgboost) # Precision for Random Forest
                self.logger_object.log(self.file_object, 'Precision for xgboost:' + str(self.xgboost_score))
            ...
            if len(test_y.unique()) == 1:#if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                self.svm_score = precision_score(test_y, self.prediction_svm) # Precision for Random Forest
                self.logger_object.log(self.file_object, 'Precision for SVM:' + str(self.svm_score))
